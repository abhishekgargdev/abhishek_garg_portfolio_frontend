...
export const CertificatesSection = () => {
  return (
    <section className="relative overflow-hidden py-24">
      <div className="pointer-events-none absolute top-1/2 left-1/2 h-[600px] w-[600px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-cyan-500/5 blur-[100px]" />
      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6">
        ...
        <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
          {certificates.map((cert, index) => (
            ...
            >
              <GlassCard className="flex h-full flex-col items-center p-6 text-center transition-all duration-300 hover:scale-105">
                <div className={`mb-5 flex h-16 w-16 items-center justify-center rounded-2xl ${cert.bg} transition-transform duration-300 group-hover:rotate-12`}>
                  {cert.icon}
                </div>
                <h3 className="mb-2 text-base font-bold text-gray-900 sm:text-lg">{cert.title}</h3>
